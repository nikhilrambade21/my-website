...
export default function CoconutOil() {
  const product = {
    ...
    description:
      "Cold pressed Coconut Oil is extracted from fresh coconuts, retaining natural nutrients and aroma. Ideal for cooking and skin care.",
