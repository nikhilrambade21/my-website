...
export default function NigerOil() {
  ...
  const product = {
    ...
    description:
      "Cold pressed Niger Oil is extracted from high-quality Niger seeds, packed with nutrients and healthy fats. Ideal for cooking and maintaining overall wellness.",
