...
export default function SafflowerOil() {
  ...
  const product = {
    ...
    description:
      "Cold pressed Safflower Oil is light and rich in unsaturated fats, ideal for cooking and promoting heart and skin health.",
