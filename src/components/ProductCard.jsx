...
export default function ProductCard({ image, title, id }) {
  ...
  const handleViewProduct = () => {
    // Navigate to individual product page using App Router
    router.push(`/products/${id}`);
  };

  return (
    <div
      className="bg-[rgb(253,252,252)] border-2 border-[rgb(231,200,115)] 
    ...
    >
      ...
      {/* TITLE */}
      <h3 className="mt-4 text-lg font-bold text-[#4A3A1B]">{title}</h3>
